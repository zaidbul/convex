...
export const Route = createFileRoute("/layout-guides/sidebar-non-collapsible")({
  component: SidebarNonCollapsibleRoutePage,
});
...
function SidebarNonCollapsibleRoutePage() {
  return (
    <SidebarProvider className="items-start">
      <Sidebar collapsible="none" className="sticky top-0 h-svh self-start shrink-0 bg-surface-low">
        <SidebarHeader>
          <SidebarMenu>
            <SidebarMenuItem>
