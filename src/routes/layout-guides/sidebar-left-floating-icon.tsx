...
export const Route = createFileRoute("/layout-guides/sidebar-left-floating-icon")({
  component: SidebarLeftFloatingIconRoutePage,
});
...
function SidebarLeftFloatingIconRoutePage() {
  return (
    <SidebarProvider>
